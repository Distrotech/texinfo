/* search.h -- Structure used to search large bodies of text, with bounds.
   $Id: search.h,v 1.2 2003-12-24 15:12:48 uid65818 Exp $
...
SEARCH_BINDING *make_binding (char *buffer, long int start, long int end), *copy_binding (SEARCH_BINDING *binding);
extern long search_forward (char *string, SEARCH_BINDING *binding), search_backward (char *input_string, SEARCH_BINDING *binding), search (char *string, SEARCH_BINDING *binding);
...
extern int skip_whitespace (char *string), skip_non_whitespace (char *string);
extern int skip_whitespace_and_newlines (char *string), skip_line (char *string);
extern int skip_node_characters (char *string, int newlines_okay), skip_node_separator (char *body);
#define DONT_SKIP_NEWLINES 0
#define SKIP_NEWLINES 1

extern long find_node_separator (SEARCH_BINDING *binding), find_tags_table (SEARCH_BINDING *binding);
