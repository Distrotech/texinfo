...
mkdir $basename
echo "perl -I $srcdir/../.. -I $srcdir/../../maintain/lib/Unicode-EastAsianWidth/lib/ -I $srcdir/../../maintain/lib/libintl-perl/lib -I $srcdir/../../maintain/lib/Text-Unidecode/lib/ -w $srcdir/../../texi2any.pl --set-init-var 'TEXI2HTML 1' --set-init-var 'TEST 1' --set-init-var L2H_TMP=$tmp_dir --conf-dir $srcdir/../../init --set-init-var 'L2H 1' --set-init-var L2H_FILE=$srcdir/../../t/init/l2h.init --iftex --out $basename/ $srcdir/../tex_html/tex_complex.texi $srcdir/../tex_html/tex.texi --force >> $stdout_file 2>$basename/${basename}.2" >> $logfile
perl -I $srcdir/../.. -I $srcdir/../../maintain/lib/Unicode-EastAsianWidth/lib/ -I $srcdir/../../maintain/lib/libintl-perl/lib -I $srcdir/../../maintain/lib/Text-Unidecode/lib/ -w $srcdir/../../texi2any.pl --set-init-var 'TEXI2HTML 1' --set-init-var 'TEST 1' --set-init-var L2H_TMP=$tmp_dir --conf-dir $srcdir/../../init --set-init-var 'L2H 1' --set-init-var L2H_FILE=$srcdir/../../t/init/l2h.init --iftex --out $basename/ $srcdir/../tex_html/tex_complex.texi $srcdir/../tex_html/tex.texi --force >> $stdout_file 2>$basename/${basename}.2
