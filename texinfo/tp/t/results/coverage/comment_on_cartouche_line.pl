...
$result_trees{'comment_on_cartouche_line'}{'contents'}[0]{'contents'}[1]{'extra'}{'spaces_after_command'} = $result_trees{'comment_on_cartouche_line'}{'contents'}[0]{'contents'}[1]{'args'}[0]{'contents'}[0];
...
$result_trees{'comment_on_cartouche_line'}{'contents'}[0]{'extra'}{'spaces_after_command'} = $result_trees{'comment_on_cartouche_line'}{'contents'}[0]{'args'}[0]{'contents'}[0];
...
$result_converted{'xml'}->{'comment_on_cartouche_line'} = '<cartouche><!-- c comment -->
<para>in cartouche.
</para></cartouche>
';
