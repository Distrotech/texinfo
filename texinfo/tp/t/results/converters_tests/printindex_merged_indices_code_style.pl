...
<cindex index="cp" spaces=" "><indexterm index="cp">c&textldquo;b</indexterm></cindex>

<vindex index="vr" spaces=" "><indexterm index="vr" incode="0">v&textldquo;j</indexterm></vindex>
...
<indexcommand command="cdiindex" index="cdi" spaces=" "><indexterm index="cdi" incode="0">cdi&textldquo;h</indexterm></indexcommand>

<defindex value="ddi" line=" ddi"></defindex>

<syncodeindex from="ddi" to="cp" line=" ddi cp"></syncodeindex>

<indexcommand command="ddiindex" index="ddi" spaces=" "><indexterm index="ddi" incode="1">ddi``g</indexterm></indexcommand>
