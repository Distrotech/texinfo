...
</pre></menudescription></menuentry><menuentry><menunode>b<verb delimiter=":">  </verb></menunode><menudescription><pre xml:space="preserve">
...
$result_converted{'info'}->{'spaces_in_node_names'} = 'This is , produced by tp version from .
