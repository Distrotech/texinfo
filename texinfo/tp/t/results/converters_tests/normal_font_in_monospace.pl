...
$result_trees{'normal_font_in_monospace'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'contents'}[0]{'extra'}{'command'} = $result_trees{'normal_font_in_monospace'}{'contents'}[0]{'contents'}[2];
...
$result_trees{'normal_font_in_monospace'}{'contents'}[0]{'contents'}[2]{'extra'}{'command'} = $result_trees{'normal_font_in_monospace'}{'contents'}[0];
