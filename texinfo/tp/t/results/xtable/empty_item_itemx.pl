...
</tableterm></tableentry><tableentry><tableterm><item><itemformat command="asis"><indexterm index="vr">in item before end table</indexterm>in item before end table</itemformat></item>
