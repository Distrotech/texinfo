...
\txicmd{@dotless}{\ttbraced{i|j}}{Generate dotless \i\ and \j.}
...
\txicmd{@textdegree}{\ttbraced{}}{Produce the degree symbol, $^\circ$.}
...
\txicmd{@codequoteundirected}{on|off}{Use undirected single quote for @code{'}; default off.}
\txicmd{@codequotebacktick}{on|off}{Use backtick (standalone grave accent) for @code{`}; default off.}
