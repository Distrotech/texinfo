...
$result_trees{'ref_to_float'}{'contents'}[4]{'contents'}[0]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'ref_to_float'}{'contents'}[4]{'contents'}[0]{'args'}[0];
...
$result_trees{'ref_to_float'}{'contents'}[6]{'contents'}[0]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'ref_to_float'}{'contents'}[6]{'contents'}[0]{'args'}[0];
