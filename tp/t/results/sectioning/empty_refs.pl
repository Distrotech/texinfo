...
$result_trees{'empty_refs'}{'contents'}[0]{'contents'}[0]{'extra'}{'brace_command_contents'}[0][0] = $result_trees{'empty_refs'}{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'}[0];
...
$result_trees{'empty_refs'}{'contents'}[0]{'contents'}[0]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'empty_refs'}{'contents'}[0]{'contents'}[0]{'args'}[0];
...
$result_trees{'empty_refs'}{'contents'}[0]{'contents'}[2]{'extra'}{'brace_command_contents'}[0][0] = $result_trees{'empty_refs'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_trees{'empty_refs'}{'contents'}[0]{'contents'}[2]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'empty_refs'}{'contents'}[0]{'contents'}[2]{'args'}[0];
