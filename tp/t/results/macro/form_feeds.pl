...
$result_trees{'form_feeds'}{'contents'}[8]{'contents'}[0]{'parent'} = $result_trees{'form_feeds'}{'contents'}[8];
$result_trees{'form_feeds'}{'contents'}[8]{'contents'}[1]{'parent'} = $result_trees{'form_feeds'}{'contents'}[8];
$result_trees{'form_feeds'}{'contents'}[8]{'contents'}[2]{'parent'} = $result_trees{'form_feeds'}{'contents'}[8];
