...
$result_trees{'empty_ref'}{'contents'}[1]{'contents'}[0]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'empty_ref'}{'contents'}[1]{'contents'}[0]{'args'}[0];
...
$result_trees{'empty_ref'}{'contents'}[1]{'contents'}[2]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'empty_ref'}{'contents'}[1]{'contents'}[2]{'args'}[0];
